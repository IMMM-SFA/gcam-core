  ...
  if(!gcamusa.USE_ELEC_DEMAND_SEGMENTS) {
    if(command == driver.DECLARE_INPUTS) {
      ...
      if(command == driver.DECLARE_INPUTS) {
        ...
        L103.load_segments_sector <- get_data(all_data, "L103.load_segments_sector_gcamusa", strip_attributes=TRUE)
        L104.HistoricalDD_S_Segment <- get_data(all_data, "L104.HistoricalDD_S_Segment_gcamusa", strip_attributes=TRUE)
        L104.DD_S_Segment_all <- get_data(all_data, "L104.DD_S_Segment_all_gcamusa", strip_attributes=TRUE)
        L244.ThermalBaseService <- get_data(all_data, "L244.ThermalBaseService_gcamusa", strip_attributes=TRUE)
        L244.ThermalServiceSatiation <- get_data(all_data, "L244.ThermalServiceSatiation_gcamusa", strip_attributes=TRUE)
        L244.Intgains_scalar <- get_data(all_data, "L244.Intgains_scalar_gcamusa", strip_attributes=TRUE)
        L244.Floorspace <- get_data(all_data, "L244.Floorspace_gcamusa", strip_attributes=TRUE)
        L244.ShellConductance_bld <- get_data(all_data, "L244.ShellConductance_bld_gcamusa", strip_attributes=TRUE)
        L244.SubsectorShrwtFllt_bld <- get_data(all_data, "L244.SubsectorShrwtFllt_bld_gcamusa", strip_attributes=TRUE)
        L244.SubsectorInterp_bld <- get_data(all_data, "L244.SubsectorInterp_bld_gcamusa", strip_attributes=TRUE)
        L244.SubsectorInterpTo_bld <- get_data(all_data, "L244.SubsectorInterpTo_bld_gcamusa", strip_attributes=TRUE)
        L244.StubTech_bld <- get_data(all_data, "L244.StubTech_bld_gcamusa", strip_attributes=TRUE)
        L244.StubTechCalInput_bld <- get_data(all_data, "L244.StubTechCalInput_bld_gcamusa", strip_attributes=TRUE)
        ...
        L226.TechCoef_electd_USA <- get_data(all_data, "L226.TechCoef_electd_USA", strip_attributes=TRUE)
