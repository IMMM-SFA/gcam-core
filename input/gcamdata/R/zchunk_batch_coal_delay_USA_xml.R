...
module_gcamusa_batch_coal_delay_USA_xml <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c("L2231.SubsectorShrwt_elec_coal_delay_USA",
    ...
    L2231.SubsectorShrwt_elec_coal_delay_USA <- get_data(all_data, "L2231.SubsectorShrwt_elec_coal_delay_USA")
    ...
    create_xml("coal_delay_USA.xml") %>%
      ...
      add_xml_data_generate_levels(L2231.SubsectorShrwt_elec_coal_delay_USA, "SubsectorShrwt",
