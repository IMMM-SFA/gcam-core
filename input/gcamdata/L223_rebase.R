...
states_subregions <- read_csv("./inst/extdata/gcam-usa/states_subregions.csv", comment = "#")
calibrated_techs <- read_csv("./inst/extdata/energy/calibrated_techs.csv", comment = "#")
NREL_us_re_technical_potential <- read_csv("./inst/extdata/gcam-usa/NREL_us_re_technical_potential.csv", comment = "#")

A23.globaltech_eff <- read_csv("./inst/extdata/energy/A23.globaltech_eff.csv", comment = "#")
A23.globaltech_OMfixed <- read_csv("./inst/extdata/energy/A23.globaltech_OMfixed.csv", comment = "#")
A23.globaltech_OMvar <- read_csv("./inst/extdata/energy/A23.globaltech_OMvar.csv", comment = "#")
A23.globaltech_capital <- read_csv("./inst/extdata/energy/A23.globaltech_capital.csv", comment = "#")
A23.globaltech_retirement <- read_csv("./inst/extdata/energy/A23.globaltech_retirement.csv", comment = "#")
A23.globaltech_shrwt <- read_csv("./inst/extdata/energy/A23.globaltech_shrwt.csv", comment = "#")
A23.globaltech_co2capture <- read_csv("./inst/extdata/energy/A23.globaltech_co2capture.csv", comment = "#")

L114.CapacityFactor_wind_state <- read_csv("./outputs/L114.CapacityFactor_wind_state.csv", comment = "#")
L114.CapacityFactor_wind_state_segment <- read_csv("./outputs/L114.CapacityFactor_wind_state_segment.csv", comment = "#")
L119.CapacityFactor_PV_state <- read_csv( "./outputs/L119.CapacityFactor_PV_state.csv", comment = "#" )
L119.CapacityFactor_CSP_state <- read_csv( "./outputs/L119.CapacityFactor_CSP_state.csv", comment = "#" )
L119.CapFacScaler_PV_state <- read_csv("./outputs/L119.CapFacScaler_PV_state.csv", comment = "#")
L119.CapacityFactor_PV_state_segment <- read_csv("./outputs/L119.CapacityFactor_PV_state_segment.csv", comment = "#")
L119.CapFacScaler_CSP_state <- read_csv("./outputs/L119.CapFacScaler_CSP_state.csv", comment = "#")
L119.CapacityFactor_CSP_state_segment <- read_csv("./outputs/L119.CapacityFactor_CSP_state_segment.csv", comment = "#")

L123.in_EJ_state_elec_F_tech <- read_csv("./outputs/L123.in_EJ_state_elec_F_tech.csv", comment = "#")
L123.out_EJ_state_elec_F_tech <- read_csv("./outputs/L123.out_EJ_state_elec_F_tech.csv", comment = "#")
L123.capacity_EJ_state_elec_F_tech <- read_csv("./outputs/L123.capacity_EJ_state_elec_F_tech.csv", comment = "#")
L123.capacity_factor_EJ_state_elec_F_tech <- read_csv("./outputs/L123.capacity_factor_EJ_state_elec_F_tech.csv", comment = "#")
L1232.out_EJ_sR_elec <- read_csv("./outputs/L1232.out_EJ_sR_elec.csv", comment = "#")
L126.out_EJ_state_td_elec <- read_csv("./outputs/L126.out_EJ_state_td_elec.csv", comment = "#")

L223.Supplysector_elec <- read_csv("./outputs/L223.Supplysector_elec.csv", comment = "#")
L223.ElecReserve <- read_csv("./outputs/L223.ElecReserve.csv", comment = "#")
L223.SubsectorLogit_elec <- read_csv("./outputs/L223.SubsectorLogit_elec.csv", comment = "#")
L223.SubsectorShrwtFllt_elec <- read_csv("./outputs/L223.SubsectorShrwtFllt_elec.csv", comment = "#")
L223.SubsectorShrwt_nuc <- read_csv("./outputs/L223.SubsectorShrwt_nuc.csv", comment = "#")
L223.SubsectorShrwt_renew <- read_csv("./outputs/L223.SubsectorShrwt_renew.csv", comment = "#")
L223.SubsectorInterp_elec <- read_csv("./outputs/L223.SubsectorInterp_elec.csv", comment = "#")
L223.SubsectorInterpTo_elec <- read_csv("./outputs/L223.SubsectorInterpTo_elec.csv", comment = "#")
L223.StubTech_elec <- read_csv("./outputs/L223.StubTech_elec.csv", comment = "#")
L223.StubTechEff_elec <- read_csv("./outputs/L223.StubTechEff_elec.csv", comment = "#")
L223.StubTechCapFactor_elec <- read_csv("./outputs/L223.StubTechCapFactor_elec.csv", comment = "#")
L223.GlobalIntTechBackup_elec <- read_csv("./outputs/L223.GlobalIntTechBackup_elec.csv", comment = "#")

L102.load_segments <- read_csv("./inst/extdata/gcam-usa/dispatch/L102.load_segments.csv", comment = "#")
L102.invest_segments <- read_csv("./inst/extdata/gcam-usa/dispatch/L102.invest_segments.csv", comment = "#")
A23.dispatch_sector <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_sector.csv", comment = "#")
A23.dispatch_sector_state_share <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_sector_state_share.csv", comment = "#")
A23.dispatch_subsector_interp <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_subsector_interp.csv", comment = "#")
A23.dispatch_subsector_shrwt <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_subsector_shrwt.csv", comment = "#")
A23.dispatch_subsector_logit <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_subsector_logit.csv", comment = "#")
A23.dispatch_globaltech_eff_additional <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_globaltech_eff_additional.csv", comment = "#")
A23.dispatch_globaltech_OMfixed_additional <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_globaltech_OMfixed_additional.csv", comment = "#")
A23.dispatch_globaltech_OMvar_additional <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_globaltech_OMvar_additional.csv", comment = "#")
A23.dispatch_globaltech_capital_additional <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_globaltech_capital_additional.csv", comment = "#")
A23.dispatch_globaltech_retirement_additional <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_globaltech_retirement_additional.csv", comment = "#")
A23.dispatch_globaltech_shrwt_additional <- read_csv("./inst/extdata/gcam-usa/A23.dispatch_globaltech_shrwt_additional.csv", comment = "#")
calibrated_techs_dispatch_usa <- read_csv("./inst/extdata/gcam-usa/calibrated_techs_dispatch_usa.csv", comment = "#")
...
L223.GlobalTechEff_Investment %>%
  ...
  # add regional energy market, originally optional, now just make is a default option
  left_join_error_no_match(states_subregions %>% select(state, grid_region) %>% rename(region = state), by = "region") %>%
  mutate(market.name = ifelse(minicam.energy.input %in% gcamusa.REGIONAL_FUEL_MARKETS, grid_region, market.name)) %>%
  select(-grid_region) ->
  L223.StubTechMarket_Investment
...
#   L223.SubsectorLogitTables_Investment[[curr_table]]$data %<>% filter(!(paste(region, subsector) %in% geo_states_noresource))
# }
...
#   L223.SubsectorLogitTables_Dispatch[[curr_table]]$data %<>% filter(!(paste(region, subsector) %in% geo_states_noresource))
# }
